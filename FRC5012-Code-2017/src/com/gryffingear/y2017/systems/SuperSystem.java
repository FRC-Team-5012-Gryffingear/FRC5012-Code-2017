...
public class SuperSystem {
	...
	private SuperSystem() {
		...
		// visionPid = new
		// GryffinPIDController(Constants.SuperSystem.AUTO_AIM_KP, 0, 0,
		// vision, visionOut);
		//
		...
		ARM_LED_A = new LedOutput(Ports.UtilityArm.ARM_LED_A, Ports.Pneumatics.PCM_CAN_ID);
		ARM_LED_B = new LedOutput(Ports.UtilityArm.ARM_LED_B, Ports.Pneumatics.PCM_CAN_ID);

		ARM_LED_C = new LedOutput(Ports.UtilityArm.ARM_LED_C, Ports.Pneumatics.PCM_CAN_ID);
